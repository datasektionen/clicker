defmodule ClickExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClickExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClickExWeb.Gettext, "errors", msg, opts)
    end
  end
